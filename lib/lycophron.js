                ...
                for (i = 0; i < specialCaseMaxAttempt; i += 1) {
                    ...
                    for (j = 0; j < specialCaseWord.length; j += 1) {
                        ...
                        if (this.isConsonant(letter) && tmpConsonants.indexOf(letter) > -1) {
                            ...
                            goodCandidate = false;
                            console.debug('not enough letters in bag ' + specialCaseWord + ' letter: ' + letter + ' (' + this.encodeLetter(letter) + ')');
                            break;
                        }
                    }
                    ...
                    if (goodCandidate && lettersConsonants.length <= numConsonants && lettersVowels.length <= numVowels) {
                        ...
                        vowels = tmpVowels;
                        console.debug('good candidate ' + specialCaseWord);
                        break;
                    } else {
                        lettersConsonants = [];
                        lettersVowels = [];
                        console.debug('not a good candidate ' + specialCaseWord);
                    }
                }
            } else {
                console.error('problem with full dictionary');
            }
        } else {
            console.debug('game does not have enough letters for ' + specialCaseLength);
        }
